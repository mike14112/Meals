        ...
        <div
            ...
            <div class="form-modal py-11 px-6 top-6 right-6 sm:h-full  ">
                ...
                <form action=""
                    ...
                    <div class="modal-group flex flex-col gap-4 p-1  ">
                        <input type="text" placeholder="Ваше Имя" minlength="4" maxlength="10"
                            class="input-name mt-3 border-none rounded-xl text-[#b1b1b1] w-72  p-1"
                            v-model.trim="formData.name">
                        <input type="number" minlength="12" maxlength="12" placeholder="Телефон  "
                            class="input-phone mt-3 border-none rounded-xl text-[#b1b1b1] w-72 p-1"
                            v-model.trim="formData.phone">
                        <div class="radio-section flex flex-col gap-4 ">
                            <span>
                        ...
                        <div class="delivery-section  w-[18.5rem] sm:mb-[22rem]" v-show="formData.isTake == 'delivery'">
                            <input type=" text" placeholder="Улица, дом, квартира"
                                class="input-adress mb-4 rounded-xl p-1" v-model="formData.adress">
                            <div class="section-home-input flex gap-12">
                                <input type="number" class="input-floor w-36 rounded-xl p-1" min="1" max="100"
                                    maxlength="2" placeholder="Этаж" v-model="formData.floor">
                                <input type="number " placeholder="Домофон" maxlength="4" min="1" max="999"
                                    class="input-intercom w-36 rounded-xl p-1" v-model="formData.cityCom">
                            </div>
                        </div>
                    </div>
                    <button
